...
public class ExaminationApplicationTests {
	...
	public ExaminationApplicationTests(double paramLambda)
        {
        ...
        public static void main(String[] args) throws IOException
        {
            ...
            String trainFile = "E:\\myeclipse\\simpleSvm\\train_bc";
            loadData(X,y,trainFile);


            ExaminationApplicationTests svm = new ExaminationApplicationTests(0.0001);
            svm.Train(X,y,7000);

            double[] test_y = new double[283];
            double[][] test_X = new double[283][11];
            String testFile = "E:\\myeclipse\\simpleSvm\\test_bc";
